...
public void user_enters_all_valid_data() throws Throwable {
	objhbpg.setPffname("Shivani");	Thread.sleep(1000);
	objhbpg.setPflname("Gollakista");	Thread.sleep(1000);
	objhbpg.setPfemail("shivanigollakista2003@yahoo.com");	Thread.sleep(1000);
	objhbpg.setPfmobile("7178856012");	Thread.sleep(1000);
	...
	objhbpg.setPfcardholder("Gollakista Shivani");	Thread.sleep(1000);
